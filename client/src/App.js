...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      const instance = new web3.eth.Contract(
        ...
        "0xA4cb96f7586A646986aD5AfDAae68B9B2DCf3DEB",
      );
  ...
  signData = async () => {
    ...
    web3.currentProvider.sendAsync({
      ...
      primaryType:"set",
      domain:{name:"SetTest",version:"1",chainId:netId,verifyingContract:"0xA4cb96f7586A646986aD5AfDAae68B9B2DCf3DEB"},
      message:{
        sender: signer,
        x: x
        // deadline: deadline
      ...
      web3.currentProvider.sendAsync({
        ...
        await contract.methods.executeSetIfSignatureMatch(v,r,s,signer, x).send({ from: accounts[0] });
      }) 
    })
  }
  render() {
